...
/ip firewall nat \
:if ([:len [find comment="GitHub\_Fastly\_133\_to\_154\_dstnat"]] = 0) do={\
add action=dst-nat chain=dstnat dst-address=185.199.108.133 dst-port=443 protocol=tcp to-addresses=185.199.108.154 comment="GitHub\_Fastly\_133\_to\_154\_dstnat" place-before=[find comment="GitHub\_Fastly\_fix\_dstnat"];\
add action=dst-nat chain=dstnat dst-address=185.199.109.133 dst-port=443 protocol=tcp to-addresses=185.199.109.154 comment="GitHub\_Fastly\_133\_to\_154\_dstnat" place-before=[find comment="GitHub\_Fastly\_fix\_dstnat"];\
add action=dst-nat chain=dstnat dst-address=185.199.110.133 dst-port=443 protocol=tcp to-addresses=185.199.110.154 comment="GitHub\_Fastly\_133\_to\_154\_dstnat" place-before=[find comment="GitHub\_Fastly\_fix\_dstnat"];\
add action=dst-nat chain=dstnat dst-address=185.199.111.133 dst-port=443 protocol=tcp to-addresses=185.199.111.154 comment="GitHub\_Fastly\_133\_to\_154\_dstnat" place-before=[find comment="GitHub\_Fastly\_fix\_dstnat"];\
:put "Add nat rules GitHub_Fastly_133_to_154_dstnat"} \
:if ([:len [find comment="GitHub\_Fastly\_133\_to\_154\_output"]] = 0) do={\
add action=dst-nat chain=output dst-address=185.199.108.133 dst-port=443 protocol=tcp to-addresses=185.199.108.154 comment="GitHub\_Fastly\_133\_to\_154\_output" place-before=[find comment="GitHub\_Fastly\_fix\_output"];\
add action=dst-nat chain=output dst-address=185.199.109.133 dst-port=443 protocol=tcp to-addresses=185.199.109.154 comment="GitHub\_Fastly\_133\_to\_154\_output" place-before=[find comment="GitHub\_Fastly\_fix\_output"];\
add action=dst-nat chain=output dst-address=185.199.110.133 dst-port=443 protocol=tcp to-addresses=185.199.110.154 comment="GitHub\_Fastly\_133\_to\_154\_output" place-before=[find comment="GitHub\_Fastly\_fix\_output"];\
add action=dst-nat chain=output dst-address=185.199.111.133 dst-port=443 protocol=tcp to-addresses=185.199.111.154 comment="GitHub\_Fastly\_133\_to\_154\_output" place-before=[find comment="GitHub\_Fastly\_fix\_output"];\
:put "Add nat rules GitHub_Fastly_133_to_154_output"} \
:if ([:len [find comment="GitHub\_Fastly\_fix\_dstnat"]] = 0) do={add action=netmap chain=dstnat dst-address=185.199.108.0/22 to-addresses=185.199.109.0/24 comment="GitHub\_Fastly\_fix\_dstnat"; :put "Add nat rule GitHub_Fastly_fix_dstnat"} \
:if ([:len [find comment="GitHub\_Fastly\_fix\_output"]] = 0) do={add action=netmap chain=output dst-address=185.199.108.0/22 to-addresses=185.199.109.0/24 comment="GitHub\_Fastly\_fix\_output"; :put "Add nat rule GitHub_Fastly_fix_output"}
