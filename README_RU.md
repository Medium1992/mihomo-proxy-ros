...
:if ([:len [/ip firewall nat find comment="GitHub_Fastly_fix_dstnat"]] = 0) do={/ip firewall nat add action=netmap chain=dstnat dst-address=185.199.108.0/22 to-addresses=185.199.109.0/24 comment="GitHub_Fastly_fix_dstnat"; :put "Add nat rule GitHub_Fastly_fix_dstnat"} \
:if ([:len [/ip firewall nat find comment="GitHub_Fastly_fix_output"]] = 0) do={/ip firewall nat add action=netmap chain=output dst-address=185.199.108.0/22 to-addresses=185.199.109.0/24 comment="GitHub_Fastly_fix_output"; :put "Add nat rule GitHub_Fastly_fix_output"} \
:if ([:len [/ip firewall nat find comment="GitHub_Fastly_133_to_154_dstnat"]] = 0) do={\
/ip firewall nat add action=dst-nat chain=dstnat dst-address=185.199.108.133 dst-port=443 protocol=tcp to-addresses=185.199.108.154 comment="GitHub_Fastly_133_to_154_dstnat" place-before=[/ip firewall nat find comment="GitHub_Fastly_fix_dstnat"];\
/ip firewall nat add action=dst-nat chain=dstnat dst-address=185.199.109.133 dst-port=443 protocol=tcp to-addresses=185.199.109.154 comment="GitHub_Fastly_133_to_154_dstnat" place-before=[/ip firewall nat find comment="GitHub_Fastly_fix_dstnat"];\
/ip firewall nat add action=dst-nat chain=dstnat dst-address=185.199.110.133 dst-port=443 protocol=tcp to-addresses=185.199.110.154 comment="GitHub_Fastly_133_to_154_dstnat" place-before=[/ip firewall nat find comment="GitHub_Fastly_fix_dstnat"];\
/ip firewall nat add action=dst-nat chain=dstnat dst-address=185.199.111.133 dst-port=443 protocol=tcp to-addresses=185.199.111.154 comment="GitHub_Fastly_133_to_154_dstnat" place-before=[/ip firewall nat find comment="GitHub_Fastly_fix_dstnat"];\
:put "Add nat rules GitHub_Fastly_133_to_154_dstnat"} \
:if ([:len [/ip firewall nat find comment="GitHub_Fastly_133_to_154_output"]] = 0) do={\
/ip firewall nat add action=dst-nat chain=output dst-address=185.199.108.133 dst-port=443 protocol=tcp to-addresses=185.199.108.154 comment="GitHub_Fastly_133_to_154_output" place-before=[/ip firewall nat find comment="GitHub_Fastly_fix_output"];\
/ip firewall nat add action=dst-nat chain=output dst-address=185.199.109.133 dst-port=443 protocol=tcp to-addresses=185.199.109.154 comment="GitHub_Fastly_133_to_154_output" place-before=[/ip firewall nat find comment="GitHub_Fastly_fix_output"];\
/ip firewall nat add action=dst-nat chain=output dst-address=185.199.110.133 dst-port=443 protocol=tcp to-addresses=185.199.110.154 comment="GitHub_Fastly_133_to_154_output" place-before=[/ip firewall nat find comment="GitHub_Fastly_fix_output"];\
/ip firewall nat add action=dst-nat chain=output dst-address=185.199.111.133 dst-port=443 protocol=tcp to-addresses=185.199.111.154 comment="GitHub_Fastly_133_to_154_output" place-before=[/ip firewall nat find comment="GitHub_Fastly_fix_output"];\
:put "Add nat rules GitHub_Fastly_133_to_154_output"}
